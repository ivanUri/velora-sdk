...
`;
function buildCfgLiteral(queries, options = {}) {
...
export function buildResolveExpression(queries, options = {}) {
...
export function buildCountExpression(queries) {
...
//# sourceMappingURL=locator-query.js.map